...
<head>
    ...
    <title>Invoice - {{ $purchase->invoice_no ?? 'N/A' }}</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
<body class="bg-gray-100 font-sans antialiased text-gray-900">

<div class="py-8 min-h-screen flex justify-center no-print px-4">
...
<style>
    ...
    /* Mobile View Adjustments (Web) */
    @media screen and (max-width: 768px) {
        .classic-invoice { width: 100%; overflow-x: auto; font-size: 11px; padding: 10px; }
        .c-table { font-size: 11px; }
    }
                ...
                <tr>
                    ...
                    <td style="width: 40%; vertical-align: top; padding: 5px 0 0 5px;">
                        <table class="c-table" style="margin-bottom: 0;">
                            ...
                            <tr><td class="nowrap" style="font-weight:bold; padding: 1px 0;">Order Status:</td><td style="padding: 1px 0;">{{ $purchase->status ?? 'N/A' }}</td></tr>
