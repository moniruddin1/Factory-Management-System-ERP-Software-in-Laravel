    ...
    <style>
        ...
        @media print {
            ...
            *, html, body, .main-content, .overflow-x-auto, .overflow-y-auto, .overflow-auto {
            ...
            main, #main-content { margin-left: 0 !important; padding-left: 0 !important; }

            .main-content { padding: 0 !important; margin: 0 !important; width: 100% !important; max-width: 100% !important; display: block !important; box-shadow: none !important; }
            ...
            .text-indigo-600, .text-indigo-700, .text-gray-500, .dark\:text-white { color: #000 !important; }

            .signature-section { display: flex !important; justify-content: space-between; margin-top: 80px !important; page-break-inside: avoid; }
        }
    </style>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6 md:p-8">
                ...
                <div class="text-center border-b border-gray-200 dark:border-slate-700 pb-4 mb-6 print-header hidden">
                    ...
                    <h2 class="text-xl font-bold text-gray-600 dark:text-slate-300 mt-1">Payment Summary Report</h2>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 print-hidden">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-white tracking-tight">Payment Summary</h2>
                        <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">
                    ...
                    <div class="text-right bg-indigo-50 dark:bg-slate-800 px-5 py-3 rounded-xl border border-indigo-200 dark:border-indigo-700 shadow-sm">
                        <p class="text-xs font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-wider mb-1">Total Payment</p>
                        <h3 class="text-2xl font-black text-indigo-700 dark:text-indigo-300">৳ {{ number_format($totalPayment, 2) }}</h3>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-slate-700">
                    <table class="w-full text-left text-sm border-collapse">
                        ...
                        <tr class="bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-300 uppercase text-xs font-bold border-b border-gray-200 dark:border-slate-700">
                            ...
                            <th class="p-4 whitespace-nowrap">Receipt/Voucher No</th>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors">
                                ...
                                <td class="p-4">
                                        <span class="font-mono text-xs font-bold bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-slate-300 px-2 py-1 rounded">
                                            {{ $payment->receipt_no ?? $payment->voucher_no ?? 'N/A' }}
                                        </span>
                                </td>
                                <td class="p-4 font-bold text-gray-900 dark:text-white">
                                    {{ $payment->supplier->company_name ?? 'Unknown Supplier' }}
                                </td>
                            ...
                            <tr>
                                <td colspan="5" class="p-10 text-center">
                                    <div class="flex flex-col items-center justify-center text-gray-400 dark:text-slate-500">
                                        <i class="fa-solid fa-money-bill-wave text-4xl mb-3 opacity-50"></i>
                                        <p class="font-medium text-lg">No payment records found</p>
                        ...
                        <tr>
                            ...
                            <td class="p-4 text-right font-black text-xl text-indigo-600 dark:text-indigo-400">
